...
cabe = {'User-agent': 'Mozilla/5.0 (X11; Linux x86_64; rv:62.0) Gecko/20100101 Firefox/62.0'}
...
#PEGANDO A DATA
utc_offset = objeto.find('div', class_="eighteen-days-countdown-bar").find('span').get('data-countdown-to')
#TRADUZINDO A DATA
def get_date(utc_offset):
    utc_offset = int(utc_offset) * 1000 
    now = datetime.datetime.utcnow()
    h = ((now.hour + 2 )* 3600000) # Vai TNC!!! Tive que dar um sambarilove na hora...
    m = (now.minute * 60000)
    s = (now.second * 1000)
