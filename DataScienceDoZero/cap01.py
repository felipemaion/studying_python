...
num_friends_by_id.sort(key=lambda user_id_numOfFriends: user_id_numOfFriends[1], reverse=True)
...
print("most_common_interests_with(users[0]):", most_common_interests_with(users[0]))
