...
# The first 8 characters of the code are 01001000,
# which is 72 in the binary numeral system.
...
print(messageFromBinaryCode(code = "010010000110010101101100011011000110111100100001"))